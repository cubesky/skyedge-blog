...
self.addEventListener('fetch', function(event) {
  if (event.request.method === 'GET') {
    ...
    var navigateFallback = 'public/offline.html';
    if (!shouldRespond &&
        navigateFallback &&
